...
class Users extends MY_Controller {
    ...
    public function new_user(){
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('common/footer', $data);
        } else { // Validation passed, now escape the 

            $password = random_string('alnum', 8);
            $hash = $this->encryption->sha1($password);
    ...
    public function edit_user(){
        ...
        if ($this->form_validation->run() == FALSE) { 
            ...
            $data['usr_add2'] = array('name' => 'usr_add2', 'class' =>'form-control', 'id' => 'usr_add2', 'value' =>set_value('usr_add2', $usr_add1), 'maxlength' => '100','size' => '35');
            $data['usr_add3'] = array('name' => 'usr_add3', 'class' =>'form-control', 'id' => 'usr_add1', 'value' =>set_value('usr_add3', $usr_add1), 'maxlength' => '100','size' => '35');
